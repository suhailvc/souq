import 'package:atobuy_vendor_flutter/controller/order/purchase_history/purchase_history_filter_controller.dart';
...
class PurchaseHistoryListFilterScreen extends StatelessWidget {
  const PurchaseHistoryListFilterScreen({super.key});
  ...
  Widget build(final BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<PurchaseHistoryListController>(
            builder: (final PurchaseHistoryListController listController) {
          return GetBuilder<PurchaseHistoryFilterController>(
              init: PurchaseHistoryFilterController(
                  listController: listController),
              builder:
                  (final PurchaseHistoryFilterController filterController) {
                return Column(
                  children: <Widget>[
                    Gap(8),
                    Expanded(
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    FilterStatusItemWrapWidget<OrderStatus>(
                                      list: filterController.orderStatusList,
                                      getPrintableText:
