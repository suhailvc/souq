...
class StateTextFieldWidget extends StatelessWidget {
  const StateTextFieldWidget(
      {super.key, required this.selectedState, required this.onStateChange});

  final Region? selectedState;
  final Function(Region?) onStateChange;
  @override
    ...
    return GetBuilder<GlobalController>(
      ...
      return Container(
        ...
        child: DropdownSearch<Region>(
          items: globalController.stateList,
          selectedItem: selectedState,
          itemAsString: (final Region country) => country.name ?? '',
          popupProps: PopupProps<Region>.modalBottomSheet(
            onDismissed: () {
            ...
            itemBuilder: (final BuildContext context, final Region item,
          ...
          dropdownBuilder: (final BuildContext context, final Region? country) {
            return Row(
              children: <Widget>[
                Padding(
          ...
          onChanged: (final Region? value) => onStateChange.call(value),
        ),
      );
    });
  }
