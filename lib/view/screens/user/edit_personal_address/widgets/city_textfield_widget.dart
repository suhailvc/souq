...
class CityTextFieldWidget extends StatelessWidget {
  ...
  final Function(City?) onCityChange;
  @override
    ...
    return GetBuilder<GlobalController>(
      ...
      return Container(
        ...
        child: DropdownSearch<City>(
          items: globalController.cityList,
          selectedItem: selectedCity,
          itemAsString: (final City country) => country.name ?? '',
          popupProps: PopupProps<City>.modalBottomSheet(
            onDismissed: () {
            ...
            itemBuilder: (final BuildContext context, final City item,
          ...
          dropdownBuilder: (final BuildContext context, final City? city) {
            return Row(
              children: <Widget>[
                Padding(
          ...
          onChanged: (final City? value) => onCityChange.call(value),
        ),
      );
    });
  }
