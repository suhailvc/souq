...
class ProductBrandTextFieldWidget extends StatelessWidget {
  const ProductBrandTextFieldWidget({
    super.key,
  ...
  final Function(Brand?) onSelectBrand;
  @override
  Widget build(final BuildContext context) {
    return Container(
      ...
      child: DropdownSearch<Brand>(
        ...
        itemAsString: (final Brand brand) => brand.title ?? '',
        popupProps: PopupProps<Brand>.modalBottomSheet(
          onDismissed: () {
          ...
          itemBuilder: (final BuildContext context, final Brand item,
        ...
        dropdownBuilder: (final BuildContext context, final Brand? brand) {
          return Column(
        ...
        onChanged: (final Brand? brand) => onSelectBrand.call(brand),
      ),
    );
  }
}
