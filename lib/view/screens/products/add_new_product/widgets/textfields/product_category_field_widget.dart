...
class ProductCategoryTextFieldWidget extends StatelessWidget {
  const ProductCategoryTextFieldWidget({
    super.key,
  ...
  Widget build(final BuildContext context) {
    return Container(
      ...
      child: DropdownSearch<Category>(
        ...
        onChanged: (final Category? value) => onSelectCategory.call(value),
      ),
    );
  }
}
