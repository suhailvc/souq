...
class FlutterSwitch extends StatefulWidget {
  ...
  const FlutterSwitch({
    ...
    this.switchBgColor = Colors.transparent,
    this.toggleBgColor = Colors.transparent,
...
class _FlutterSwitchState extends State<FlutterSwitch>
  ...
  @override
  void didUpdateWidget(final FlutterSwitch oldWidget) {
  ...
  Widget build(final BuildContext context) {
    Color _toggleColor = widget.toggleBgColor;
    final Color _switchColor = widget.switchBgColor;
